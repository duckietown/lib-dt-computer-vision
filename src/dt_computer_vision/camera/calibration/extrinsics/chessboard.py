...
def find_corners(image: BGRImage, board: CalibrationBoard, camera: CameraModel = None, win_size: int = 3) -> List[Pixel]:
    """
    ...
    Args:
        ...
        camera (:obj:``dt_computer_vision.camera.types.CameraModel``): Camera
